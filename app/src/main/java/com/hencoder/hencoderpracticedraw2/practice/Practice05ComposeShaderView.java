...
public class Practice05ComposeShaderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        Shader shader1 = new BitmapShader(getBitmapFromResource(R.drawable.batman), Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader shader2 = new BitmapShader(getBitmapFromResource(R.drawable.batman_logo), Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
